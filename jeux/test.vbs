...
Dim fso
Dim choice
choice = MsgBox("Que voulez-vous faire ?" & vbNewLine & "1. Jouer à pierre-papier-ciseaux" & vbNewLine & "2. Lancer le quiz" & vbNewLine & "3. S'inscrire ou se connecter", vbExclamation + vbYesNoCancel, "Choix")
